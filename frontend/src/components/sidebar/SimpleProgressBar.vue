...
<template>
   <div>
      ...
      <div :style="progress_style" class="vue-simple-progress">
         <div
         ...
         <div :style="bar_style" class="vue-simple-progress-bar">
            <div v-if="text.length > 0 && textPosition === 'inside'" :style="text_style">
               {{ text }}
            </div>
         </div>
      </div>
