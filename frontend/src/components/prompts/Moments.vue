<template>
   <div class="card floating moments-popup">
      ...
      <div :class="{ 'vertical': isMobile }" class="card-content">
         ...
         <div v-else :class="{ 'vertical': isMobile }" class="moments-list">
            <div
            ...
            >
               <div class="thumbnail-container">
                  <img :src="moment.url" alt="Moment Preview" class="moment-thumbnail" />
